...
- Fragment Shaders:
	- zig build-obj -ODebug -target spirv64-vulkan -mcpu baseline+variable_pointers --dep IM "-Mroot=assets\shaders\SDFFragShaderOverlay.zig" "-MIM=src\Imaginengion\ImagineShaders.zig" --name SDFFragShaderOverlay
	- zig build-obj -ODebug -target spirv64-vulkan -mcpu baseline+variable_pointers --dep IM "-Mroot=assets\shaders\SDFFragShaderGame.zig" "-MIM=src\Imaginengion\ImagineShaders.zig" --name SDFFragShaderGame