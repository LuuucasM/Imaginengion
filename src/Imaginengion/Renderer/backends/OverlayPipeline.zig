...
const FragmentShader = @import("SDFVertShader");
...
const OverlayPipeline = @This();

mPipeline: ?*sdl.SDL_GPUGraphicsPipeline = null,

pub fn Init(self: *OverlayPipeline, engine_context: *EngineContext) !void {
...
pub fn Deinit(self: *OverlayPipeline, engine_context: *EngineContext) void {
    const device: *sdl.SDL_GPUDevice = @ptrCast(engine_context.mRenderer.mPlatform.GetDevice());
...
pub fn Bind(self: OverlayPipeline, render_pass: *anyopaque) void {
...
pub fn PushUniforms(_: OverlayPipeline, cmd: *anyopaque, push: PushConstants) void {
...
pub fn Draw(_: OverlayPipeline, render_pass: *anyopaque) void {
    const sdl_render_pass: *sdl.SDL_GPURenderPass = @ptrCast(render_pass);
