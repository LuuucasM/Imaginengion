...
pub fn ImguiRender(self: Material, engine_context: *EngineContext) void {
    _ = engine_context;
    try ImguiManager.RenderColor4Edit(&self.mSurfaceColor, "Color");
    try ImguiManager.RenderVec3(&self.Absorption, "Absorption", 0, 0.075, 100.0);

    try ImguiManager.RenderEnum(OpaqueMode, &self.mOpaqueMode, "Opaque Mode");
}
